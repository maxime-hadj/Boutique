...
<body>
    ...
    <main>
        ...
        ?>
            ...
            <p><a href="boutique.php?id=<?=$_GET['id_produit'];?>"><img style="width:50px; height:50px;" src="./images/panier.jpg" alt="panier"></a></p>
            </div>
        </div>
        ...
        <div class="containerDetailsImg">
            <img src="<?php print $imgDetailss['link'] ?>">
        </div>
            </div>
            <?php
            }
